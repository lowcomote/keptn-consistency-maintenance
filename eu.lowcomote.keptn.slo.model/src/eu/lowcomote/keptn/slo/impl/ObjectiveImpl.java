 ...
 * </p>
 * <ul>
 *   <li>{@link eu.lowcomote.keptn.slo.impl.ObjectiveImpl#getObjective <em>Objective</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectiveImpl extends MinimalEObjectImpl.Container implements Objective {
	 ...
	 * @ordered
	 */
	protected EList<ObjectivePropertiesAbstract> objective;
	...
	protected EClass eStaticClass() {
		return SloPackage.Literals.OBJECTIVE;
	}
	 ...
	 * @generated
	 */
	public EList<ObjectivePropertiesAbstract> getObjective() {
		if (objective == null) {
			objective = new EObjectContainmentEList<ObjectivePropertiesAbstract>(ObjectivePropertiesAbstract.class, this, SloPackage.OBJECTIVE__OBJECTIVE);
		}
		return objective;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SloPackage.OBJECTIVE__OBJECTIVE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SloPackage.OBJECTIVE__OBJECTIVE:
				getObjective().clear();
				getObjective().addAll((Collection<? extends ObjectivePropertiesAbstract>)newValue);
				return;
		}
